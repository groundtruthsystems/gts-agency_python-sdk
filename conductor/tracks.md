...
- [x] **Track: Conflict-body envelope parsing (work-queue 409) → rc13**
*Link: [./tracks/conflict_envelope_20260718/](./tracks/conflict_envelope_20260718/)*

**Status:** ✅ COMPLETE (2026-07-22) — **rc13 PUBLISHED to PyPI** (PR #12 merged `1125d6d`; tag `v0.0.1rc13` → CI run 29965083524 SUCCESS; PyPI latest = `0.0.1rc13`). ③ swaps its editable link for the `==0.0.1rc13` pin. History below retained.
