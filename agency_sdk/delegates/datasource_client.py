...
class AgencyDatasourceClient:
    ...
    def list_tables(self, datasource_id: str, organisation_id: int, page: int = 0, size: int = 10) -> DatasourceTablesPagedResult:
    ...
    def get_table(self, datasource_id: str, table_name: str, organisation_id: int) -> DatasourceTableDetail:
        """Get detailed information about a specific table."""
        params = {"o": str(organisation_id)}
        return DatasourceTableDetail(**self._make_request('GET', f"/{datasource_id}/tables/{table_name}", params=params))
